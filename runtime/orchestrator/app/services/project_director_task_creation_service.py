...
class ProjectDirectorTaskCreationService:
    ...
    def create_tasks_from_plan_version(
        ...
        # Create tasks
        created_tasks = self._create_tasks(plan_version)
    ...
    def _create_tasks(
        ...
        """Convert each proposed_task into a real Task."""
        created: list[Task] = []
