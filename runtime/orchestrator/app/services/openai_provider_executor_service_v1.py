"""OpenAI Provider Executor V1 archived implementation.

This file preserves the pre-P21-B1 urllib/socket based implementation for
learning, comparison, and rollback reference. It is not the default runtime
entrypoint after P21-B1.
"""
