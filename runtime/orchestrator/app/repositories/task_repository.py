...
class TaskRepository:
    ...
    def _latest_run_to_domain(run_rows: list[RunTable]) -> Run | None:
        ...
        return Run(
            ...
            provider_key=latest_run_row.provider_key,
            prompt_template_key=latest_run_row.prompt_template_key,
            prompt_template_version=latest_run_row.prompt_template_version,
            prompt_char_count=latest_run_row.prompt_char_count,
            token_accounting_mode=latest_run_row.token_accounting_mode,
            provider_receipt_id=latest_run_row.provider_receipt_id,
            total_tokens=latest_run_row.total_tokens,
            token_pricing_source=latest_run_row.token_pricing_source,
