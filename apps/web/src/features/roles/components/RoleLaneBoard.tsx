    ...
    <section className="border-b border-[#333333] pb-5">
      <div className="flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <h3 className="mt-2 text-lg font-semibold text-zinc-50">按角色查看当前协作负载</h3>
      ...
      <div className="mt-4 grid gap-5 xl:grid-cols-4">
        {props.lanes.map((lane) => {
          const isSelected = lane.role_code === props.selectedRoleCode;
          return (
            <section
              key={lane.role_code}
              className={`border-b border-[#333333] pb-4 transition ${isSelected ? "bg-white/[0.025]" : ""}`}
            >
              <button
                type="button"
