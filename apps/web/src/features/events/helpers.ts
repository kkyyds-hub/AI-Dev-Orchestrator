...
function toConsoleRun(run: StreamRunPayload): ConsoleRun {
  return {
    ...
    token_accounting_mode: null,
    provider_receipt_id: null,
    total_tokens: null,
    token_pricing_source: null,
    role_model_policy_source: null,
    role_model_policy_desired_tier: null,
    role_model_policy_adjusted_tier: null,
    role_model_policy_final_tier: null,
