...
export function BudgetPolicyEditorCard(props: {
  ...
  return (
    <section id="team-budget-settings" className="scroll-mt-24 border-b border-[#333333] pb-6">
      <div>
      ...
      <div className="mt-4 divide-y divide-[#333333] border-t border-[#333333]">
        <label className="grid gap-3 py-4 text-sm md:grid-cols-[220px_minmax(0,1fr)]">
          ...
          <input
            ...
            className="w-40 rounded border border-[#3a3a3a] bg-transparent px-3 py-2 text-sm text-zinc-100 outline-none transition focus:border-zinc-500"
          />
        </label>
        <label className="grid gap-3 py-4 text-sm md:grid-cols-[220px_minmax(0,1fr)]">
