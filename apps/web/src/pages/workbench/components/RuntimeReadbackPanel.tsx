...
export function RuntimeReadbackPanel() {
  const realExecutorReadbackMutation = useRealExecutorLaunchReadback();
  ...
  const handleBuildRealExecutorReadback = () => {
    realExecutorReadbackMutation.mutate({
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3">
        ...
        <RealExecutorLaunchReadbackCard
          readback={realExecutorReadbackMutation.data ?? null}
          loading={realExecutorReadbackMutation.isPending}
          error={
            realExecutorReadbackMutation.isError
              ? realExecutorReadbackMutation.error.message
              : null
          }
          onBuild={handleBuildRealExecutorReadback}
        />
...
function RealExecutorLaunchReadbackCard(props: {
  ...
  const blockingReasons = readback?.blocking_reasons ?? [
    "adapter remains disabled until a future approved phase",
  ];
  const displaySteps = readback?.display_steps ?? [
