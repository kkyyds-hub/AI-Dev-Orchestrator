...
| CL-17 | 页面闭环 | 页面按钮是否真实闭环 | R1-A~F: 工作台 7 按钮全部真实 POST API + 状态展示；scope fix: taskCreation.projectId（verification-project-director-worker-run-r1fb-20260529 v2） | 无假按钮 | Runtime Pass (工作台) | 工作台 7 按钮全闭环；全站 CL-17 仍需其他页面验收 |
