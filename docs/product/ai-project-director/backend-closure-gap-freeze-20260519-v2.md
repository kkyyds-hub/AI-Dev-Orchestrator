...
| BCG-15 | 提交草案 | 仓库工作区 | commit-candidate GET/POST | BCG-15A live evidence: first draft v1 (draft, evidence_package_key, verification 1/1 passed), second revision v2 (custom fields, v1+v2 preserved), detail/list read-back, protection paths (404, 409 preflight), review-only boundary; 68/68 passed, 0 gaps | Backend Pass / Runtime Evidence Pass | BCG-15A 验证了 review-only draft 全链路 | P0 证据 / P0 收口 | BCG-15 Runtime Evidence Pass；后续接 BCG-16 apply-local（需独立入口和全面安全边界） |
