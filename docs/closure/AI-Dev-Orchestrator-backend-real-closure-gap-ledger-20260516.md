...
| 2026-05-16 | BCL-08 diag 适配修复 | `46de856` | smoke 9/9 passed; rollup diagnostics_unavailable=0 | Pass | 修复 _build_project_diag 中 FailureReviewService 构造参数（run_repository→failure_review_repository+run_logging_service）；113 个 project diagnostics 全部正常输出 blocked + real blocking_reason_codes |
