...
| `P4交付预览与人工确认总账-20260607.md` | P4 ledger（本文档） | P4-F4 证据已追加 |
...
所有文档已迁移至 `docs/产品文档/AI项目主管/04-P4交付预览与人工确认/`。

| 文档 | 文件名 | 类型 |
|------|------|------|
| P4-E2 + P4-F Design | `P4E2收口与人工确认门设计-20260606.md` | Design |
| P4-F1 Closure | `P4F1人工确认域模型收口-20260606.md` | Closure |
| P4-F2-A Closure | `P4F2A后端透传骨架收口-20260606.md` | Closure |
| P4-F2-B Design | `P4F2B确认接口设计-20260606.md` | Design |
| P4-F2-C0 Closure | `P4F2C0证据快照源收口-20260607.md` | Closure |
| P4-F2-C Closure | `P4F2C确认接口收口-20260607.md` | Closure |
| P4-F2-D Design | `P4F2D审批审计设计-20260607.md` | Design |
| P4-F2-D Closure | `P4F2D审批审计收口-20260607.md` | Closure |
| P4-F3 Design | `P4F3前端确认入口设计-20260607.md` | Design |
| **P4 Ledger** | **`P4交付预览与人工确认总账-20260607.md`** | **Ledger（本文档）** |
